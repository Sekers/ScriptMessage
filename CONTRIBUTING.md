...
- **The automated tests never connect to a tenant.** If a change needs a live Microsoft Graph test, you don't need
  a test tenant: any tenant you're allowed to test in will do, as long as every message and file you send goes
  only to accounts you control. Describe what you tested in the pull request.
